 ...
 *
 * Adapter.kt puts the content from "Timeline_artist.kt" to the XML file
 */
...
class AdapterTimeline_artist(
    private val exampleList: List<Timeline_artist.ExampleItem3>,
    private val listener: ItemListener
) :
    RecyclerView.Adapter<AdapterTimeline_artist.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.userId.text = currentItem.uId
    ...
    /**
     * @param: itemView: View
     * get RecyclerView item from "activity_timeline_artist.xml"
     */
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val userId: TextView = itemView.hidden
        ...
        fun donate(listener: ItemListener) {
            donate_btn.setOnClickListener { itemView ->
                listener.onClicked(
                    imageView,
